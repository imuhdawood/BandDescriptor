...
K_RANGE = [2, 3, 5]#list(range(2, 6))  # Range of K to test for optimal clustering
K = 3
FIG_SIZE = (8, 10)
...
if __name__ == "__main__":
    ...
    for cell_type in celltypes_selected:
        ...
        INPUT_FILE = f'{PATH}/band_features_{cell_type}_cell_id_br1.csv'
        OUT_PATH = f'{OUTPATH}/br1_k{K}/{cell_type}'
